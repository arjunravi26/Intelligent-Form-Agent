...
class ExtractiveQA:
    def __init__(self, claim_data: str):
        self.claim_data = claim_data if isinstance(claim_data, str) else str(claim_data)
...
if __name__ == "__main__":
    ...
    print(type(claim_data))
    context = claim_data if isinstance(claim_data, str) else str(claim_data)
    print(type(context))
    extractive_qa = ExtractiveQA(claim_data=context)
